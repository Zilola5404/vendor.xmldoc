...
/**
 * Итоги документа УПД (шапка ВсегоОпл).
 *
 * В режиме 1C/ЭДО шапка и сумма строк могут отличаться на 1–2 коп. по net/tax
 * (Diadoc корректирует НДС при расхождении net от gross/(1+НДС%)).
 */
final class DocumentTotalsCalculator
{
    ...
    public static function finalize1C(array $lineTotals, float $taxRate = 22.0): array
    {
        ...
        // Баланс сохраняется (net + tax = gross), но net/tax сдвигаются к net из gross/1.22.
