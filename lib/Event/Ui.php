...
class Ui
{
    ...
    private static function resolveJsPath(): string
    {
        ...
        if (is_file($_SERVER['DOCUMENT_ROOT'] . '/local/modules/ooofix.vendor.xml/install/js/generate.js')) {
            return $siteDir . 'local/modules/ooofix.vendor.xml/install/js/generate.js?v=' . rawurlencode($version);
        }
    ...
    {
        $siteDir = self::siteDir();
        if (is_file($_SERVER['DOCUMENT_ROOT'] . '/local/modules/ooofix.vendor.xml/ajax/generate.php')) {
            return $siteDir . 'local/modules/ooofix.vendor.xml/ajax/generate.php';
        }

        if (is_file($_SERVER['DOCUMENT_ROOT'] . '/bitrix/tools/ooofix_vendor_xml_generate.php')) {
            return $siteDir . 'bitrix/tools/ooofix_vendor_xml_generate.php';
        }
