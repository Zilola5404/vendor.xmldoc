...
final class ValidationMessages
{
    ...
    private const MESSAGES = [
        ...
        'signatory_position' => 'Заполните должность подписанта в настройках модуля vendor.xmldoc.',
    ...
    {
        return 'Итоговая сумма по товарам не сходится. Пересохраните товарные позиции в карточке.';
    }
