...
<form method="get" action="">
    ...
    <a href="/bitrix/admin/settings.php?mid=ooofix.xmlupd&lang=<?= LANGUAGE_ID ?>">Настройки модуля</a>
</form>
<br>

<?php if (!ModuleTableHealth::isDocumentTableReady()): ?>
    <div class="adm-info-message-wrap adm-info-message-red">
        <span class="adm-info-message-text">Таблица b_xmldoc_document не найдена. Переустановите модуль или выполните обновление до 1.4.0.</span>
    </div>
    <br>
<?php endif; ?>
